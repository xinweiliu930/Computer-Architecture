...
int isLabel(char*lLabel)
{  //printf("%c\n",*lLabel);

if(*lLabel!='x'&&strcmp(lLabel,"in")!=0&&strcmp(lLabel,"out")!=0&&strcmp(lLabel,"getc")!=0&&strcmp(lLabel,"puts")!=0&&strlen(lLabel)<=20&&isOpcode(lLabel)==-1&&strcmp(lLabel,".orig")!=0&&strcmp(lLabel,".end")!=0&&strcmp(lLabel,".fill")!=0&&isalnum(*lLabel)!=0 ) 
   {
return 0;}
   else return -1;
}        

int isLabe(char*lLabel);
int adr(char*label);
int trans(char*Arg);
int toNum( char * pStr );
int isOpcode(char*Opcode);
...
{               //printf("%s\n",lOpcode);
		...
		{           if(beg==1&&isOpcode(lOpcode)==-1&&strcmp(lOpcode,".orig")!=0&&strcmp(lOpcode,".end")&&strcmp(lOpcode,".fill"))
		            ...
		            pci=pci+2;
                            ...
                            {if((*lArg1=='x'||*lArg1=='#')&&strlen(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)
                             {  pc=toNum(lArg1);
                               pci=pc-2;
                               beg=1;
                            ...
                            if (beg==1&&strcmp(lOpcode,".fill")==0)
                            { if((*lArg1=='x'||*lArg1=='#')&&strlen(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)
                             {if(toNum(lArg1)>=0&&toNum(lArg1)<=65535)
                              {reg= toNum(lArg1);  fprintf(outfile,"0x%.4X\n",reg);}
                              else if (toNum(lArg1)<0&&toNum(lArg1)>=-32768)
                              {tem = 0xFFFF;reg= tem&toNum(lArg1); fprintf(outfile,"0x%.4X\n",reg);
                              }else exit(3);
                            ...
                            { if(*lArg1=='r'&&*lArg2=='r'&&(*lArg3=='#'||*lArg3=='x'||*lArg3=='r')&&strlen(lArg4)==0)
                             {tem=1;tem1=0x1F;
                               if (*lArg3=='r')
                            ...
                            { if(isLabel(lArg1)==0&&strlen(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)
                              { tem = 0x800;
                           ...
                           {if(*lArg1=='r'&&strlen(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)
                              { tem = 12;
                           ...
                           {if(*lArg1=='r'&&*lArg2=='r'&&(*lArg3=='#'||*lArg3=='x')&&strlen(lArg4)==0)
                              {tem = 2;
                               tem1 = 0x003F;
                               offset = toNum(lArg3);
                           ...
                           {  //printf("%d\n",isLabel(lArg1));
                             if(*lArg1=='r'&&isLabel(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)   
                             {  tem = 14;
                               tem1 = 0x1FF;
                           ...
                           {if(*lArg1=='r'&&*lArg2=='r'&&strlen(lArg3)==0&&strlen(lArg4)==0) 
                              { tem = 9;
                           ...
                           {   
                               if(*lArg1=='x'&&strlen(lArg2)==0&&strlen(lArg3)==0&&strlen(lArg4)==0)
                               {tem = 0xF000;
                                if(toNum(lArg1)>=0&&toNum(lArg1)<64)
                                {reg = tem + toNum(lArg1);
                                 fprintf(outfile,"0x%.4X\n",reg);
                                 } else exit(3); 
                               }else exit(4);
                           ...
                           { if(*lArg1=='r'&&*lArg2=='r'&&(*lArg3=='r'||*lArg3=='x'||*lArg3=='#')&&strlen(lArg4)==0)
